...
export const goToLevel = (startFloor, FinalPosition) => {
    if (startFloor < 0 || FinalPosition > 10 || startFloor === FinalPosition) return 0
    if (startFloor < FinalPosition || startFloor > FinalPosition) return (FinalPosition - startFloor)
};
